...
namespace EGGS.OnScreenUnits.MovementDesign
{
    ...
    internal abstract class MovementPattern : ICloneable
    {
        ...
        {
            int bottom = GraphicsManager.GraphicsDeviceManager.PreferredBackBufferHeight - (this.Parent.Texture.Height / 2);
        ...
        {
            int right = GraphicsManager.GraphicsDeviceManager.PreferredBackBufferWidth - (this.Parent.Texture.Width / 2);
